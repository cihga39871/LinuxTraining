...
**Linux distributions** refers to _operating systems_ include Linux kernel and supporting system software and libraries.
 ...
 - Popular Linux distributions include Debian, Fedora, Ubuntu, Red Hat, SUSE, and etc. **In this tutorial, we use Ubuntu. Other distributions might not compatible with some example codes.**
